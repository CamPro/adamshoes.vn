...
class cls_image
{
     ...
     */
    function make_thumb($img, $thumb_width = 0, $thumb_height = 0, $path = '', $bgcolor='', $name='')
    {
        ...
        /* xu li kich thuoc */
        if ($thumb_width == 0 && $thumb_height > 0) // rộng auto
        {
            $thumb_width = $thumb_height * $scale_org;
        }
        if ($thumb_height == 0 && $thumb_width > 0) // cao auto
        {
            $thumb_height = $thumb_width / $scale_org;
        }
        // neu de = 0 het thi up len sao no hien thi nhu vay
        // kich thuoc phu thuoc hinh up len
        if($thumb_width == 0 && $thumb_height == 0){
    ...
    function getsize($img){
        ...
        return array('width'=> $org_info[0], 'height'=> $org_info[1]);
    }
    ...
    function get_namefile($basename){
        $a = explode(".", basename($basename));
        $b = array_shift($a);
        return $b;
    }
