...
class captcha
{
    ...
    var $themes_jpg = array(
        1 => array('captcha.jpg', 255, 255, 255),
    );

    var $themes_gif = array(
        1 => array('captcha.gif', 255, 255, 255),
    );
     ...
     * @return void
     */
    function __construct($folder = '', $width = 80, $height = 40)
    {
     ...
     * @return  bool
     */
    function captcha($folder = '', $width = 80, $height = 40)
    {
        if (!empty($folder))
        {
            $this->folder = $folder;
