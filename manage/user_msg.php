...
function msg_list()
{
    ...
    $sql = "SELECT f.msg_id, f.user_name, g.region_name, f.msg_title, f.msg_type, f.order_id, f.msg_status, f.msg_time, f.msg_area, COUNT(r.msg_id) AS reply " .
            "FROM " . $GLOBALS['ecs']->table('feedback') . " AS f ".
            "LEFT JOIN " . $GLOBALS['ecs']->table('feedback') . " AS r ON r.parent_id=f.msg_id ".
            "LEFT JOIN " . $GLOBALS['ecs']->table('region') . " AS g ON g.region_id=f.region_id ".
