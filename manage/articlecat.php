...

{
    ...
    $is_only = $exc->is_only('acat_urlseo', $_POST['acat_urlseo']);
...

    {
        ...
        sys_msg(sprintf('Url Seo đã tồn tại', stripslashes($_POST['acat_urlseo'])), 1);
    ...
    $sql = "INSERT INTO ".$ecs->table('article_cat')."(cat_name, acat_urlseo, cat_type, meta_title,cat_desc,keywords, parent_id, sort_order, show_in_nav)

           VALUES ('$_POST[cat_name]', '$_POST[acat_urlseo]', '$cat_type',  '$_POST[cat_desc]','$_POST[meta_title]','$_POST[keywords]', '$_POST[parent_id]', '$_POST[sort_order]', '$_POST[show_in_nav]')";
...

{
    ...
    $sql = "SELECT cat_id, cat_name, acat_urlseo, cat_type, meta_title,cat_desc, show_in_nav, keywords, parent_id,sort_order FROM ".
...

{
    ...
    if ($_POST['acat_urlseo'] != $_POST['old_urlseo'])

    {

        $is_only = $exc->is_only('acat_urlseo', $_POST['acat_urlseo'], $_POST['id']);
    ...
    if ($exc->edit("cat_name = '$_POST[cat_name]', acat_urlseo = '$_POST[acat_urlseo]',meta_title='$_POST[meta_title]', cat_desc ='$_POST[cat_desc]', keywords='$_POST[keywords]',parent_id = '$_POST[parent_id]', cat_type='$cat_type', sort_order='$_POST[sort_order]', show_in_nav = '$_POST[show_in_nav]'",  $_POST['id']))
