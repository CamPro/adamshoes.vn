...
//商品管理权限
    ...
    $purview['goods_group']          = 'goods_group';
...
//促销管理权限
    ...
    $purview['11_installment']       = 'installment_manage';
...
//  $purview['02_snatch_list']       = 'gift_manage';  //赠品管理
    ...
    $purview['16_promotion']         = 'setup_promotion';
    $purview['17_giasoc']            = 'giasoc_manage';
    $purview['20_goods_group']            = 'goods_group';
...
//会员管理权限
    ...
    $purview['12_recall']             = 'requestcall_priv';
...
//订单管理权限
    ...
    $purview['11_remove_order']      = 'order_remove';
