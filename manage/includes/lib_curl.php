<?php
$api = 'https://reports.bkc.vn:448/RestFul/TraCuuTonKho.ashx?func=GetListShowRoomInStock&regionID=3';
$param = 'mhCode=25119348';
//echo get_remote_data($api); // GET request 
echo get_remote_data($api, $param); // POST request
