...
$modules['02_cat_and_goods']['20_goods_group']      = 'groupproduct.php';
...
$modules['03_promotion']['11_installment']          = 'installment.php?act=list'; // tragop
$modules['03_promotion']['17_giasoc']               = 'giasoc.php?act=list'; // gia soc
...
$modules['03_promotion']['16_promotion']            = 'promotion.php?act=setup';
...
$modules['08_members']['11_tuvan']                    = 'tuvan.php?act=list';
$modules['08_members']['12_recall']                   = 'requestcall.php?act=list';
...
//$modules['08_members']['affiliate']                 = 'affiliate.php?act=list';
//$modules['08_members']['affiliate_ck']              = 'affiliate_ck.php?act=list';
...
$modules['10_priv_admin']['map_stock']              = 'map_stock.php?act=sync_stock';
