...
if(isset($_GET['dis']) && $_GET['dis'] == 'mobile' && !isset($_COOKIE['clients'])){
    setcookie('clients', 'm', time()+ (84000*30), '/'.ADMIN_PATH);
}
elseif(isset($_GET['dis']) && $_GET['dis'] == 'desk'){
    setcookie('clients', 'm', time()-(84000*30), '/'.ADMIN_PATH);
}
$_mobile = (isset($_COOKIE['clients']) && $_COOKIE['clients'] == 'm') ? 1 : 0;

$pmsg = $_mobile == 1 ? 'message_mobile.htm' : 'message.htm';
$err = new ecs_error($pmsg);
...
$smarty->assign('mydomain', $_CFG['domain']);
